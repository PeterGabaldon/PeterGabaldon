...
of professional experience — 10+ in total, mostly self-taught. I build and run security
projects for mid-size and large companies, support the SOC through forensics and incident
response, and spend my own time hunting bugs, reversing binaries and writing offensive tooling.
Curiosity at the core — the kid who took his toys apart, now taking software apart instead.
...
**TeamViewer Kernel Driver LPE** — User-to-kernel EoP, disclosed via ZDI &nbsp;·&nbsp; [`CVE-2024-7479 / 7481`](https://github.com/PeterGabaldon/CVE-2024-7479_CVE-2024-7481) &nbsp;·&nbsp; [write-up](https://pgj11.com/posts/Finding-TeamViewer-0days-Part-1/)<br/>
**FortiOS Symlink Persistence Bypass** — patch bypass with checker tool &nbsp;·&nbsp; [`CVE-2025-68686`](https://labs.itresit.es/2026/02/11/fortigate-symlink-persistence-method-patch-bypass-cve-2025-68686/)<br/>
**Summar Employee Portal — SQLi** — full MSSQL read/write &nbsp;·&nbsp; [`CVE-2025-40677`](https://github.com/PeterGabaldon/CVE-2025-40677) &nbsp;·&nbsp; [Exploit-DB 52462](https://www.exploit-db.com/exploits/52462)<br/>
**secretsdump — Shadow Snapshot via WMI** — registry-independent credential dump &nbsp;·&nbsp; [Impacket PR #1719](https://github.com/fortra/impacket/pull/1719)<br/>
**FortiGate VPN-SSL Honeypot** — dockerised deception with counter-intel &nbsp;·&nbsp; [repo](https://github.com/PeterGabaldon/Fortigate.VPN-SSL.Honeypot)<br/>
**WhatAboutSAM** — Windows SAM dumper, no SYSTEM required &nbsp;·&nbsp; [repo](https://github.com/PeterGabaldon/WhatAboutSAM)
